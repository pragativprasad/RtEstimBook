...
Therefore, the purpose of this document is to provide guidance about which $R(t)$ estimation software to choose for different analytical goals: see our [Decision Matrix](decisiontree.qmd).
</div>
