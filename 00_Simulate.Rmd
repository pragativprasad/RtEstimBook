...
Each different components of disease outbreak that can be modeled differently: see our [Decision tool](decisiontree.qmd) for how to choose software for different analytical goals.
</div>
