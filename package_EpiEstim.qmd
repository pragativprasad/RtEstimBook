...
[This vignette](https://mrc-ide.github.io/EpiEstim/articles/full_EpiEstim_vignette.html) gives a basic example of usage of EpiEstim, including using forecasting via the [projections](package_projects.qmd) package.
